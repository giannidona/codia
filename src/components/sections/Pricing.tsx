                  ...
                  <ul className="mt-4 space-y-2">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center">
                        ...
                        {plan.featureTooltip &&
                          featureIndex === plan.featureTooltip.index && (
                            <span className="group relative ml-1 text-xs">
                              <svg
                                ...
                                className="lucide lucide-circle-help size-5 cursor-pointer opacity-50"
                              >
                                <circle cx="12" cy="12" r="10" />
                                <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
                                <path d="M12 17h.01" />
                              </svg>
                              <span className="pointer-events-none absolute left-full top-1/2 ml-2 w-max -translate-y-1/2 transform rounded bg-slate-600/40 px-2 py-1 text-xs text-white opacity-0 transition-opacity duration-300 group-hover:pointer-events-auto group-hover:opacity-100">
